# DQ Rule: ACE_00028 - Internal orders MUST have a profit center assignment when a responsible cost center is assigned.
...
|-------|-------|
| Rule ID | 00028 |
| Rule Name | Internal orders MUST have a profit center assignment when a responsible cost center is assigned. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0036_System_001_MHIS_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: internal orders must have a profit center assignment when a responsible cost center is assigned.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: internal orders must have a profit center assignment when a responsible cost center is assigned.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | MHIS | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | MHIS | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | MHIS | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | MHIS | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Internal orders MUST have a profit center assignment when a responsible cost center is assigned.
-- Rule ID: ACE_00028
...
CREATE VIEW [dbo].[DQ_ACE00028_System_001_MHIS_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00028_System_001_MHIS_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00028_System_001_MHIS_OptSel]
WHERE
