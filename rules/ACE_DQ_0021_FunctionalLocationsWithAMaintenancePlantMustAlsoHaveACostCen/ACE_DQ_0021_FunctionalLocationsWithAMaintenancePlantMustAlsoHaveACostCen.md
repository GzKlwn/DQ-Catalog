# DQ Rule: ACE_00021 - Functional locations with a maintenance plant MUST also have a cost center.
...
|-------|-------|
| Rule ID | 00021 |
| Rule Name | Functional locations with a maintenance plant MUST also have a cost center. |
| Rule Name Score | 100% |
| Data Domain | Costing |
| Object Type | Master |
...
| Generated View | DQ_0029_System_001_AUFK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: functional locations with a maintenance plant must also have a cost center.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Related Tables:** CRCA
- **Domain:** Costing
- **Scope:** All active records in MKAL
- **System Filter:** System_001 (as configured in Studio)

**3. DQ Checks (Conditions)**

- **Fetch** <br /> Retrieves all candidate records from MKAL that meet the scope criteria and filters based on the business rule requirements.

- **Check** <br /> For each record in MKAL, evaluates the defined error conditions: functional locations with a maintenance plant must also have a cost center.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Functional locations with a maintenance plant MUST also have a cost center.
-- Rule ID: ACE_00021
...
CREATE VIEW [dbo].[DQ_ACE00021_System_001_AUFK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00021_System_001_AUFK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00021_System_001_AUFK_OptSel]
WHERE
