# DQ Rule: ACE_00037 - Maintenance plans MUST NOT have an outstanding maintenance call past its planned date.
...
|-------|-------|
| Rule ID | 00037 |
| Rule Name | Maintenance plans MUST NOT have an outstanding maintenance call past its planned date. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0045_System_001_BKPF_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: maintenance plans must not have an outstanding maintenance call past its planned date.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: maintenance plans must not have an outstanding maintenance call past its planned date.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Maintenance plans MUST NOT have an outstanding maintenance call past its planned date.
-- Rule ID: ACE_00037
...
CREATE VIEW [dbo].[DQ_ACE00037_System_001_BKPF_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00037_System_001_BKPF_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00037_System_001_BKPF_OptSel]
WHERE
