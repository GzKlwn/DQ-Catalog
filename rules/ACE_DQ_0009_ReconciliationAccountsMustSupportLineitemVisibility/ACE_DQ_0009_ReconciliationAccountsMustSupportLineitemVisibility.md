# DQ Rule: ACE_00009 - Reconciliation accounts MUST support line-item visibility.
...
|-------|-------|
| Rule ID | 00009 |
| Rule Name | Reconciliation accounts MUST support line-item visibility. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0017_System_001_EQKT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: reconciliation accounts must support line-item visibility.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: reconciliation accounts must support line-item visibility.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Reconciliation accounts MUST support line-item visibility.
-- Rule ID: ACE_00009
...
CREATE VIEW [dbo].[DQ_ACE00009_System_001_EQKT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00009_System_001_EQKT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00009_System_001_EQKT_OptSel]
WHERE
