# DQ Rule: ACE_00088 - Quality inspection plan operations MUST have at least one inspection characteristic.
...
|-------|-------|
| Rule ID | 00088 |
| Rule Name | Quality inspection plan operations MUST have at least one inspection characteristic. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0096_System_001_VTTK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: quality inspection plan operations must have at least one inspection characteristic.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in QAMR, evaluates the defined error conditions: quality inspection plan operations must have at least one inspection characteristic.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Quality inspection plan operations MUST have at least one inspection characteristic.
-- Rule ID: ACE_00088
...
CREATE VIEW [dbo].[DQ_ACE00088_System_001_VTTK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00088_System_001_VTTK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00088_System_001_VTTK_OptSel]
WHERE
