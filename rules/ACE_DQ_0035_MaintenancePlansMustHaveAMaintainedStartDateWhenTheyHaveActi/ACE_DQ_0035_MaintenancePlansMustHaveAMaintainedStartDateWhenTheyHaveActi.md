# DQ Rule: ACE_00035 - Maintenance plans MUST have a maintained start date when they have active scheduling activity.
...
|-------|-------|
| Rule ID | 00035 |
| Rule Name | Maintenance plans MUST have a maintained start date when they have active scheduling activity. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0043_System_001_CABN_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: maintenance plans must have a maintained start date when they have active scheduling activity.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: maintenance plans must have a maintained start date when they have active scheduling activity.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | CABN | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | CABN | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | CABN | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | CABN | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Maintenance plans MUST have a maintained start date when they have active scheduling activity.
-- Rule ID: ACE_00035
...
CREATE VIEW [dbo].[DQ_ACE00035_System_001_CABN_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00035_System_001_CABN_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00035_System_001_CABN_OptSel]
WHERE
