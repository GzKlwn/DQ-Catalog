# DQ Rule: ACE_00032 - Released internal orders MUST have a responsible cost center assigned.
...
|-------|-------|
| Rule ID | 00032 |
| Rule Name | Released internal orders MUST have a responsible cost center assigned. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0040_System_001_IMPTT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: released internal orders must have a responsible cost center assigned.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: released internal orders must have a responsible cost center assigned.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Released internal orders MUST have a responsible cost center assigned.
-- Rule ID: ACE_00032
...
CREATE VIEW [dbo].[DQ_ACE00032_System_001_IMPTT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00032_System_001_IMPTT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00032_System_001_IMPTT_OptSel]
WHERE
