# DQ Rule: ACE_00055 - Open purchase requisition items MUST NOT show ordered quantity greater than requested quantity.
...
|-------|-------|
| Rule ID | 00055 |
| Rule Name | Open purchase requisition items MUST NOT show ordered quantity greater than requested quantity. |
| Rule Name Score | 100% |
| Data Domain | Purchase Requisitions |
| Object Type | Master |
...
| Generated View | DQ_0063_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: open purchase requisition items must not show ordered quantity greater than requested quantity.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.

**2. Specific Relevancy Criteria/Scope**

- **Primary Table:** EBAN
- **Related Tables:** N/A
- **Domain:** Purchase Requisitions
- **Scope:** All active records in EBAN
- **System Filter:** System_001 (as configured in Studio)

**3. DQ Checks (Conditions)**

- **Fetch** <br /> Retrieves all candidate records from EBAN that meet the scope criteria and filters based on the business rule requirements.

- **Check** <br /> For each record in EBAN, evaluates the defined error conditions: open purchase requisition items must not show ordered quantity greater than requested quantity.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Open purchase requisition items MUST NOT show ordered quantity greater than requested quantity.
-- Rule ID: ACE_00055
...
CREATE VIEW [dbo].[DQ_ACE00055_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00055_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00055_System_001_KONH_OptSel]
WHERE
