# DQ Rule: ACE_00042 - Measuring points and counters MUST have an upper measurement limit greater than or equal to the lower measurement limit.
...
|-------|-------|
| Rule ID | 00042 |
| Rule Name | Measuring points and counters MUST have an upper measurement limit greater than or equal to the lower measurement limit. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0050_System_001_QALS_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: measuring points and counters must have an upper measurement limit greater than or equal to the lower measurement limit.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: measuring points and counters must have an upper measurement limit greater than or equal to the lower measurement limit.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Measuring points and counters MUST have an upper measurement limit greater than or equal to the lower measurement limit.
-- Rule ID: ACE_00042
...
CREATE VIEW [dbo].[DQ_ACE00042_System_001_QALS_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00042_System_001_QALS_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00042_System_001_QALS_OptSel]
WHERE
