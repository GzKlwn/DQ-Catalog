# DQ Rule: ACE_00097 - Shipments MUST NOT have a planned end earlier than their planned start.
...
|-------|-------|
| Rule ID | 00097 |
| Rule Name | Shipments MUST NOT have a planned end earlier than their planned start. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0105_System_001_CRCA_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: shipments must not have a planned end earlier than their planned start.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: shipments must not have a planned end earlier than their planned start.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Shipments MUST NOT have a planned end earlier than their planned start.
-- Rule ID: ACE_00097
...
CREATE VIEW [dbo].[DQ_ACE00097_System_001_CRCA_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00097_System_001_CRCA_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00097_System_001_CRCA_OptSel]
WHERE
