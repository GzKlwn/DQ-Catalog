# DQ Rule: ACE_00023 - Subordinate functional locations MUST have a superior location assigned.
...
|-------|-------|
| Rule ID | 00023 |
| Rule Name | Subordinate functional locations MUST have a superior location assigned. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0031_System_001_AUFK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: subordinate functional locations must have a superior location assigned.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: subordinate functional locations must have a superior location assigned.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Subordinate functional locations MUST have a superior location assigned.
-- Rule ID: ACE_00023
...
CREATE VIEW [dbo].[DQ_ACE00023_System_001_AUFK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00023_System_001_AUFK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00023_System_001_AUFK_OptSel]
WHERE
