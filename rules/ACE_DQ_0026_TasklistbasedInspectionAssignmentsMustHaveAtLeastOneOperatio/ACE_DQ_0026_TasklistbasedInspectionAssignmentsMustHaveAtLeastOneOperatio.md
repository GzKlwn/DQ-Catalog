# DQ Rule: ACE_00026 - Task-list-based inspection assignments MUST have at least one operation in the assigned quality plan.
...
|-------|-------|
| Rule ID | 00026 |
| Rule Name | Task-list-based inspection assignments MUST have at least one operation in the assigned quality plan. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0034_System_001_AFRU_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: task-list-based inspection assignments must have at least one operation in the assigned quality plan.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in QAMR, evaluates the defined error conditions: task-list-based inspection assignments must have at least one operation in the assigned quality plan.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | AFRU | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | AFRU | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | AFRU | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | AFRU | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Task-list-based inspection assignments MUST have at least one operation in the assigned quality plan.
-- Rule ID: ACE_00026
...
CREATE VIEW [dbo].[DQ_ACE00026_System_001_AFRU_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00026_System_001_AFRU_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00026_System_001_AFRU_OptSel]
WHERE
