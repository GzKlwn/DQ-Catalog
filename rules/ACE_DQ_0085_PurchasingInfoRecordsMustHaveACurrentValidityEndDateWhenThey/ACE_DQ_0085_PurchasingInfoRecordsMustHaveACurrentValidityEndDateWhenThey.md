# DQ Rule: ACE_00085 - Purchasing info records MUST have a current validity end date when they carry maintained pricing or recent purchasing activity.
...
|-------|-------|
| Rule ID | 00085 |
| Rule Name | Purchasing info records MUST have a current validity end date when they carry maintained pricing or recent purchasing activity. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0093_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: purchasing info records must have a current validity end date when they carry maintained pricing or recent purchasing activity.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in KONV, evaluates the defined error conditions: purchasing info records must have a current validity end date when they carry maintained pricing or recent purchasing activity.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Purchasing info records MUST have a current validity end date when they carry maintained pricing or recent purchasing activity.
-- Rule ID: ACE_00085
...
CREATE VIEW [dbo].[DQ_ACE00085_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00085_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00085_System_001_KONH_OptSel]
WHERE
