# DQ Rule: ACE_00007 - VAT-liable customer business partners MUST have a tax number.
...
|-------|-------|
| Rule ID | 00007 |
| Rule Name | VAT-liable customer business partners MUST have a tax number. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0015_System_001_EQKT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vat-liable customer business partners must have a tax number.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in BUT020, evaluates the defined error conditions: vat-liable customer business partners must have a tax number.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: VAT-liable customer business partners MUST have a tax number.
-- Rule ID: ACE_00007
...
CREATE VIEW [dbo].[DQ_ACE00007_System_001_EQKT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00007_System_001_EQKT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00007_System_001_EQKT_OptSel]
WHERE
