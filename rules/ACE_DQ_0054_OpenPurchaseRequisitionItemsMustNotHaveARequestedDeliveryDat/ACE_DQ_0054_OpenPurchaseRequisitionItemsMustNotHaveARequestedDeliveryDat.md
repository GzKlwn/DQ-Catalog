# DQ Rule: ACE_00054 - Open purchase requisition items MUST NOT have a requested delivery date earlier than the requisition date.
...
|-------|-------|
| Rule ID | 00054 |
| Rule Name | Open purchase requisition items MUST NOT have a requested delivery date earlier than the requisition date. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0062_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: open purchase requisition items must not have a requested delivery date earlier than the requisition date.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in LIKP, evaluates the defined error conditions: open purchase requisition items must not have a requested delivery date earlier than the requisition date.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Open purchase requisition items MUST NOT have a requested delivery date earlier than the requisition date.
-- Rule ID: ACE_00054
...
CREATE VIEW [dbo].[DQ_ACE00054_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00054_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00054_System_001_KONH_OptSel]
WHERE
