# DQ Rule: ACE_00072 - Project operations MUST NOT carry procurement activity before order release.
...
|-------|-------|
| Rule ID | 00072 |
| Rule Name | Project operations MUST NOT carry procurement activity before order release. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0080_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: project operations must not carry procurement activity before order release.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in PROJ, evaluates the defined error conditions: project operations must not carry procurement activity before order release.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Project operations MUST NOT carry procurement activity before order release.
-- Rule ID: ACE_00072
...
CREATE VIEW [dbo].[DQ_ACE00072_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00072_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00072_System_001_KONH_OptSel]
WHERE
