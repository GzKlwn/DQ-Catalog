# DQ Rule: ACE_00046 - Inspection lots MUST be marked as decided when a usage decision has been recorded.
...
|-------|-------|
| Rule ID | 00046 |
| Rule Name | Inspection lots MUST be marked as decided when a usage decision has been recorded. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0054_System_001_EBAN_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: inspection lots must be marked as decided when a usage decision has been recorded.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in QAMR, evaluates the defined error conditions: inspection lots must be marked as decided when a usage decision has been recorded.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | EBAN | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | EBAN | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | EBAN | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | EBAN | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Inspection lots MUST be marked as decided when a usage decision has been recorded.
-- Rule ID: ACE_00046
...
CREATE VIEW [dbo].[DQ_ACE00046_System_001_EBAN_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00046_System_001_EBAN_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00046_System_001_EBAN_OptSel]
WHERE
