# DQ Rule: ACE_00010 - Hierarchy groups MUST NOT contain overlapping member ranges.
...
|-------|-------|
| Rule ID | 00010 |
| Rule Name | Hierarchy groups MUST NOT contain overlapping member ranges. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0018_System_001_EQKT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: hierarchy groups must not contain overlapping member ranges.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: hierarchy groups must not contain overlapping member ranges.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Hierarchy groups MUST NOT contain overlapping member ranges.
-- Rule ID: ACE_00010
...
CREATE VIEW [dbo].[DQ_ACE00010_System_001_EQKT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00010_System_001_EQKT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00010_System_001_EQKT_OptSel]
WHERE
