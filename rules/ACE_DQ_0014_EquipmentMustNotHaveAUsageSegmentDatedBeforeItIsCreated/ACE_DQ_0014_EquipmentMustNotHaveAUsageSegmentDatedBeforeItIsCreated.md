# DQ Rule: ACE_00014 - Equipment MUST NOT have a usage segment dated before it is created.
...
|-------|-------|
| Rule ID | 00014 |
| Rule Name | Equipment MUST NOT have a usage segment dated before it is created. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0022_System_001_IFLOT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: equipment must not have a usage segment dated before it is created.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in EQUI, evaluates the defined error conditions: equipment must not have a usage segment dated before it is created.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Equipment MUST NOT have a usage segment dated before it is created.
-- Rule ID: ACE_00014
...
CREATE VIEW [dbo].[DQ_ACE00014_System_001_IFLOT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00014_System_001_IFLOT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00014_System_001_IFLOT_OptSel]
WHERE
