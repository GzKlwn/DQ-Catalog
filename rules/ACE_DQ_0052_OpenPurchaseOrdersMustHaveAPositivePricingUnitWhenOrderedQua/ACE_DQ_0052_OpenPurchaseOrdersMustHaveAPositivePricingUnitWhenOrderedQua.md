# DQ Rule: ACE_00052 - Open purchase orders MUST have a positive pricing unit when ordered quantities are present.
...
|-------|-------|
| Rule ID | 00052 |
| Rule Name | Open purchase orders MUST have a positive pricing unit when ordered quantities are present. |
| Rule Name Score | 100% |
| Data Domain | Purchase Orders |
| Object Type | Master |
...
| Generated View | DQ_0060_System_001_VBAK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: open purchase orders must have a positive pricing unit when ordered quantities are present.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Scope:** All active records in EKKO
- **System Filter:** System_001 (as configured in Studio)

**3. DQ Checks (Conditions)**

- **Fetch** <br /> Retrieves all candidate records from EKKO that meet the scope criteria and filters based on the business rule requirements.

- **Check** <br /> For each record in EKKO, evaluates the defined error conditions: open purchase orders must have a positive pricing unit when ordered quantities are present.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | VBAK | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | VBAK | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | VBAK | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | VBAK | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Open purchase orders MUST have a positive pricing unit when ordered quantities are present.
-- Rule ID: ACE_00052
...
CREATE VIEW [dbo].[DQ_ACE00052_System_001_VBAK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00052_System_001_VBAK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00052_System_001_VBAK_OptSel]
WHERE
