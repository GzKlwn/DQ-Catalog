# DQ Rule: ACE_00008 - Vendor business partners MUST have a reconciliation account when assigned to a company code.
...
|-------|-------|
| Rule ID | 00008 |
| Rule Name | Vendor business partners MUST have a reconciliation account when assigned to a company code. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0016_System_001_EQKT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vendor business partners must have a reconciliation account when assigned to a company code.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in BUT020, evaluates the defined error conditions: vendor business partners must have a reconciliation account when assigned to a company code.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | EQKT | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | EQKT | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | EQKT | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | EQKT | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Vendor business partners MUST have a reconciliation account when assigned to a company code.
-- Rule ID: ACE_00008
...
CREATE VIEW [dbo].[DQ_ACE00008_System_001_EQKT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00008_System_001_EQKT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00008_System_001_EQKT_OptSel]
WHERE
