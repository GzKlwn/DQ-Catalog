# DQ Rule: ACE_00058 - Open sales orders awaiting billing MUST NOT have incomplete billing data.
...
|-------|-------|
| Rule ID | 00058 |
| Rule Name | Open sales orders awaiting billing MUST NOT have incomplete billing data. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0066_System_001_MKAL_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: open sales orders awaiting billing must not have incomplete billing data.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in VBAK, evaluates the defined error conditions: open sales orders awaiting billing must not have incomplete billing data.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Open sales orders awaiting billing MUST NOT have incomplete billing data.
-- Rule ID: ACE_00058
...
CREATE VIEW [dbo].[DQ_ACE00058_System_001_MKAL_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00058_System_001_MKAL_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00058_System_001_MKAL_OptSel]
WHERE
