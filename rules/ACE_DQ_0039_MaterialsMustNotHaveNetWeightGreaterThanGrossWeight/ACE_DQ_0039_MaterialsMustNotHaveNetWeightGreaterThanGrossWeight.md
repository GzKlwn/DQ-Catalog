# DQ Rule: ACE_00039 - Materials MUST NOT have net weight greater than gross weight.
...
|-------|-------|
| Rule ID | 00039 |
| Rule Name | Materials MUST NOT have net weight greater than gross weight. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0047_System_001_QALS_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: materials must not have net weight greater than gross weight.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in MARA, evaluates the defined error conditions: materials must not have net weight greater than gross weight.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Materials MUST NOT have net weight greater than gross weight.
-- Rule ID: ACE_00039
...
CREATE VIEW [dbo].[DQ_ACE00039_System_001_QALS_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00039_System_001_QALS_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00039_System_001_QALS_OptSel]
WHERE
