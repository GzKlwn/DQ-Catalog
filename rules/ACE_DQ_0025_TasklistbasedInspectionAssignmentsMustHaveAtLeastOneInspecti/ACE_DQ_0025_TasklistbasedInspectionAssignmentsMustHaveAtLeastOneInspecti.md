# DQ Rule: ACE_00025 - Task-list-based inspection assignments MUST have at least one inspection characteristic in the assigned quality plan.
...
|-------|-------|
| Rule ID | 00025 |
| Rule Name | Task-list-based inspection assignments MUST have at least one inspection characteristic in the assigned quality plan. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0033_System_001_IKPF_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: task-list-based inspection assignments must have at least one inspection characteristic in the assigned quality plan.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in QAMR, evaluates the defined error conditions: task-list-based inspection assignments must have at least one inspection characteristic in the assigned quality plan.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | IKPF | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | IKPF | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | IKPF | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | IKPF | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Task-list-based inspection assignments MUST have at least one inspection characteristic in the assigned quality plan.
-- Rule ID: ACE_00025
...
CREATE VIEW [dbo].[DQ_ACE00025_System_001_IKPF_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00025_System_001_IKPF_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00025_System_001_IKPF_OptSel]
WHERE
