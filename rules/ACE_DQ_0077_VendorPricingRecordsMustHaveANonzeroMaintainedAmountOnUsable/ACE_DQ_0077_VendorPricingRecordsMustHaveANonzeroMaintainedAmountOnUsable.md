# DQ Rule: ACE_00077 - Vendor pricing records MUST have a non-zero maintained amount on usable price lines.
...
|-------|-------|
| Rule ID | 00077 |
| Rule Name | Vendor pricing records MUST have a non-zero maintained amount on usable price lines. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0085_System_001_EINA_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vendor pricing records must have a non-zero maintained amount on usable price lines.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in LFA1, evaluates the defined error conditions: vendor pricing records must have a non-zero maintained amount on usable price lines.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Vendor pricing records MUST have a non-zero maintained amount on usable price lines.
-- Rule ID: ACE_00077
...
CREATE VIEW [dbo].[DQ_ACE00077_System_001_EINA_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00077_System_001_EINA_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00077_System_001_EINA_OptSel]
WHERE
