# DQ Rule: ACE_00069 - Profit center hierarchy names MUST NOT be reused across multiple organizational scopes.
...
|-------|-------|
| Rule ID | 00069 |
| Rule Name | Profit center hierarchy names MUST NOT be reused across multiple organizational scopes. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0077_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: profit center hierarchy names must not be reused across multiple organizational scopes.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: profit center hierarchy names must not be reused across multiple organizational scopes.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Profit center hierarchy names MUST NOT be reused across multiple organizational scopes.
-- Rule ID: ACE_00069
...
CREATE VIEW [dbo].[DQ_ACE00069_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00069_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00069_System_001_KONH_OptSel]
WHERE
