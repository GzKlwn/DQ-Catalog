# DQ Rule: ACE_00050 - Recorded usage decisions MUST identify the person who made the decision.
...
|-------|-------|
| Rule ID | 00050 |
| Rule Name | Recorded usage decisions MUST identify the person who made the decision. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0058_System_001_VBAK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: recorded usage decisions must identify the person who made the decision.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: recorded usage decisions must identify the person who made the decision.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Recorded usage decisions MUST identify the person who made the decision.
-- Rule ID: ACE_00050
...
CREATE VIEW [dbo].[DQ_ACE00050_System_001_VBAK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00050_System_001_VBAK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00050_System_001_VBAK_OptSel]
WHERE
