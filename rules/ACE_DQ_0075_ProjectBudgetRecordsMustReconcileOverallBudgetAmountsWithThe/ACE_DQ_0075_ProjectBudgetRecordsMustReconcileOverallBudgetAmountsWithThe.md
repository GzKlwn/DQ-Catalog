# DQ Rule: ACE_00075 - Project budget records MUST reconcile overall budget amounts with the corresponding annual budget amounts.
...
|-------|-------|
| Rule ID | 00075 |
| Rule Name | Project budget records MUST reconcile overall budget amounts with the corresponding annual budget amounts. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0083_System_001_EKAB_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: project budget records must reconcile overall budget amounts with the corresponding annual budget amounts.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in PROJ, evaluates the defined error conditions: project budget records must reconcile overall budget amounts with the corresponding annual budget amounts.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Project budget records MUST reconcile overall budget amounts with the corresponding annual budget amounts.
-- Rule ID: ACE_00075
...
CREATE VIEW [dbo].[DQ_ACE00075_System_001_EKAB_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00075_System_001_EKAB_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00075_System_001_EKAB_OptSel]
WHERE
