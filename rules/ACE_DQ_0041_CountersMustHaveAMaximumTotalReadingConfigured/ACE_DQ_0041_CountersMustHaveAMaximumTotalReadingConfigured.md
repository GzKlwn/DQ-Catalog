# DQ Rule: ACE_00041 - Counters MUST have a maximum total reading configured.
...
|-------|-------|
| Rule ID | 00041 |
| Rule Name | Counters MUST have a maximum total reading configured. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0049_System_001_QALS_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: counters must have a maximum total reading configured.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: counters must have a maximum total reading configured.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Counters MUST have a maximum total reading configured.
-- Rule ID: ACE_00041
...
CREATE VIEW [dbo].[DQ_ACE00041_System_001_QALS_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00041_System_001_QALS_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00041_System_001_QALS_OptSel]
WHERE
