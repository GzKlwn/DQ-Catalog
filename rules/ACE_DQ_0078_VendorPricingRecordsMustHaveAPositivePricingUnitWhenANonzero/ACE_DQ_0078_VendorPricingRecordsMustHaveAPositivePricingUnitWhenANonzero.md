# DQ Rule: ACE_00078 - Vendor pricing records MUST have a positive pricing unit when a non-zero price is maintained.
...
|-------|-------|
| Rule ID | 00078 |
| Rule Name | Vendor pricing records MUST have a positive pricing unit when a non-zero price is maintained. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0086_System_001_EINA_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vendor pricing records must have a positive pricing unit when a non-zero price is maintained.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in LFA1, evaluates the defined error conditions: vendor pricing records must have a positive pricing unit when a non-zero price is maintained.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | EINA | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | EINA | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | EINA | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | EINA | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Vendor pricing records MUST have a positive pricing unit when a non-zero price is maintained.
-- Rule ID: ACE_00078
...
CREATE VIEW [dbo].[DQ_ACE00078_System_001_EINA_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00078_System_001_EINA_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00078_System_001_EINA_OptSel]
WHERE
