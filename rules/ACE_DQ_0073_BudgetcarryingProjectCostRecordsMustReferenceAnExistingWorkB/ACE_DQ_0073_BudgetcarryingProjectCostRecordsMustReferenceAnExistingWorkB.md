# DQ Rule: ACE_00073 - Budget-carrying project cost records MUST reference an existing work breakdown structure element.
...
|-------|-------|
| Rule ID | 00073 |
| Rule Name | Budget-carrying project cost records MUST reference an existing work breakdown structure element. |
| Rule Name Score | 100% |
| Data Domain | Costing |
| Object Type | Master |
...
| Generated View | DQ_0081_System_001_KONH_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: budget-carrying project cost records must reference an existing work breakdown structure element.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in MKAL, evaluates the defined error conditions: budget-carrying project cost records must reference an existing work breakdown structure element.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Budget-carrying project cost records MUST reference an existing work breakdown structure element.
-- Rule ID: ACE_00073
...
CREATE VIEW [dbo].[DQ_ACE00073_System_001_KONH_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00073_System_001_KONH_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00073_System_001_KONH_OptSel]
WHERE
