# DQ Rule: ACE_00093 - Pricing records MUST have at least one actionable pricing item.
...
|-------|-------|
| Rule ID | 00093 |
| Rule Name | Pricing records MUST have at least one actionable pricing item. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0101_System_001_EORD_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: pricing records must have at least one actionable pricing item.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in KONV, evaluates the defined error conditions: pricing records must have at least one actionable pricing item.. Flags records that violate the rule requirements.
...
|---------|----------|-------------|-------|-------------|
| Primary Condition | = or <> | EORD | Various | Data quality validation per rule |

## Joins

| Element | Source | Target | Type | Key | Cardinality |
|---------|--------|--------|------|-----|-------------|
| System Filter | EORD | All | Alignment | zSourceSystemID = 'System_001' | N/A |
...
|-------------|----------|-------|-------|-----------|
| System Filter | = | EORD | zSourceSystemID | System_001 |

### Exclusions
| Description | Operator | Table | Field | Condition |
|-------------|----------|-------|-------|-----------|
| Exclude Deleted | <> | EORD | LVORM | X |

## SQL -- OptSel

```sql
-- ============================================================
-- DQ Rule: Pricing records MUST have at least one actionable pricing item.
-- Rule ID: ACE_00093
...
CREATE VIEW [dbo].[DQ_ACE00093_System_001_EORD_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00093_System_001_EORD_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00093_System_001_EORD_OptSel]
WHERE
