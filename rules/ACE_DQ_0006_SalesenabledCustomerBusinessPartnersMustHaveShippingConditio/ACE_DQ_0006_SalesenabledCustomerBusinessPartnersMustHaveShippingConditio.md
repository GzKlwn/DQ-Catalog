# DQ Rule: ACE_00006 - Sales-enabled customer business partners MUST have shipping conditions maintained.
...
|-------|-------|
| Rule ID | 00006 |
| Rule Name | Sales-enabled customer business partners MUST have shipping conditions maintained. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0014_System_001_EQKT_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: sales-enabled customer business partners must have shipping conditions maintained.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in BUT020, evaluates the defined error conditions: sales-enabled customer business partners must have shipping conditions maintained.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Sales-enabled customer business partners MUST have shipping conditions maintained.
-- Rule ID: ACE_00006
...
CREATE VIEW [dbo].[DQ_ACE00006_System_001_EQKT_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00006_System_001_EQKT_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00006_System_001_EQKT_OptSel]
WHERE
