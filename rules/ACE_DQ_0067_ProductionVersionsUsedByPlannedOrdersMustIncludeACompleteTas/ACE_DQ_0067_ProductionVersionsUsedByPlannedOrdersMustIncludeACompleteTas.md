# DQ Rule: ACE_00067 - Production versions used by planned orders MUST include a complete task list reference.
...
|-------|-------|
| Rule ID | 00067 |
| Rule Name | Production versions used by planned orders MUST include a complete task list reference. |
| Rule Name Score | 100% |
| Data Domain | Routing |
| Object Type | Master |
...
| Generated View | DQ_0075_System_001_BPGE_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: production versions used by planned orders must include a complete task list reference.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in ROUT, evaluates the defined error conditions: production versions used by planned orders must include a complete task list reference.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Production versions used by planned orders MUST include a complete task list reference.
-- Rule ID: ACE_00067
...
CREATE VIEW [dbo].[DQ_ACE00067_System_001_BPGE_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00067_System_001_BPGE_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00067_System_001_BPGE_OptSel]
WHERE
