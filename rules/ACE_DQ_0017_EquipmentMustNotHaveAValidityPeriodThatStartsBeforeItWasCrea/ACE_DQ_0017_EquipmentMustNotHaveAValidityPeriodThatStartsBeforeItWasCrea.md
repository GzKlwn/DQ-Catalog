# DQ Rule: ACE_00017 - Equipment MUST NOT have a validity period that starts before it was created.
...
|-------|-------|
| Rule ID | 00017 |
| Rule Name | Equipment MUST NOT have a validity period that starts before it was created. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0025_System_001_MAPL_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: equipment must not have a validity period that starts before it was created.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in EQUI, evaluates the defined error conditions: equipment must not have a validity period that starts before it was created.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Equipment MUST NOT have a validity period that starts before it was created.
-- Rule ID: ACE_00017
...
CREATE VIEW [dbo].[DQ_ACE00017_System_001_MAPL_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00017_System_001_MAPL_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00017_System_001_MAPL_OptSel]
WHERE
