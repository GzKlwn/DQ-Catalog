# DQ Rule: ACE_00079 - Vendor pricing records MUST have at least one usable price line.
...
|-------|-------|
| Rule ID | 00079 |
| Rule Name | Vendor pricing records MUST have at least one usable price line. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0087_System_001_MAPL_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vendor pricing records must have at least one usable price line.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in LFA1, evaluates the defined error conditions: vendor pricing records must have at least one usable price line.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Vendor pricing records MUST have at least one usable price line.
-- Rule ID: ACE_00079
...
CREATE VIEW [dbo].[DQ_ACE00079_System_001_MAPL_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00079_System_001_MAPL_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00079_System_001_MAPL_OptSel]
WHERE
