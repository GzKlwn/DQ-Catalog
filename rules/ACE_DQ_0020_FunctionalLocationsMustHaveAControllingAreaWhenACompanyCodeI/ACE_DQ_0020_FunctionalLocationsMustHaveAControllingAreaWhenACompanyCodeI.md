# DQ Rule: ACE_00020 - Functional locations MUST have a controlling area when a company code is assigned.
...
|-------|-------|
| Rule ID | 00020 |
| Rule Name | Functional locations MUST have a controlling area when a company code is assigned. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0028_System_001_AUFK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: functional locations must have a controlling area when a company code is assigned.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: functional locations must have a controlling area when a company code is assigned.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Functional locations MUST have a controlling area when a company code is assigned.
-- Rule ID: ACE_00020
...
CREATE VIEW [dbo].[DQ_ACE00020_System_001_AUFK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00020_System_001_AUFK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00020_System_001_AUFK_OptSel]
WHERE
