# DQ Rule: ACE_00090 - Sales contract line commitments MUST have a positive quantity or value when the line is not rejected.
...
|-------|-------|
| Rule ID | 00090 |
| Rule Name | Sales contract line commitments MUST have a positive quantity or value when the line is not rejected. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0098_System_001_VTTK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: sales contract line commitments must have a positive quantity or value when the line is not rejected.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: sales contract line commitments must have a positive quantity or value when the line is not rejected.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Sales contract line commitments MUST have a positive quantity or value when the line is not rejected.
-- Rule ID: ACE_00090
...
CREATE VIEW [dbo].[DQ_ACE00090_System_001_VTTK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00090_System_001_VTTK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00090_System_001_VTTK_OptSel]
WHERE
