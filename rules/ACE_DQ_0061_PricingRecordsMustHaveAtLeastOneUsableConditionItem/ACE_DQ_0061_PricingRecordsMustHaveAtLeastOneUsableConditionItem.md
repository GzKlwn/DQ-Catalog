# DQ Rule: ACE_00061 - Pricing records MUST have at least one usable condition item.
...
|-------|-------|
| Rule ID | 00061 |
| Rule Name | Pricing records MUST have at least one usable condition item. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0069_System_001_SETHEADER_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: pricing records must have at least one usable condition item.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in KONV, evaluates the defined error conditions: pricing records must have at least one usable condition item.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Pricing records MUST have at least one usable condition item.
-- Rule ID: ACE_00061
...
CREATE VIEW [dbo].[DQ_ACE00061_System_001_SETHEADER_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00061_System_001_SETHEADER_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00061_System_001_SETHEADER_OptSel]
WHERE
