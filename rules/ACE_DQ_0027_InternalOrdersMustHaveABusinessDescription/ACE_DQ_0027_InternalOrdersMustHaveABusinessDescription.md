# DQ Rule: ACE_00027 - Internal orders MUST have a business description.
...
|-------|-------|
| Rule ID | 00027 |
| Rule Name | Internal orders MUST have a business description. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0035_System_001_MHIS_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: internal orders must have a business description.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: internal orders must have a business description.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Internal orders MUST have a business description.
-- Rule ID: ACE_00027
...
CREATE VIEW [dbo].[DQ_ACE00027_System_001_MHIS_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00027_System_001_MHIS_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00027_System_001_MHIS_OptSel]
WHERE
