# DQ Rule: ACE_00081 - Vendor pricing records MUST use the same pricing classification across the header and usable price lines.
...
|-------|-------|
| Rule ID | 00081 |
| Rule Name | Vendor pricing records MUST use the same pricing classification across the header and usable price lines. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0089_System_001_MAPL_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: vendor pricing records must use the same pricing classification across the header and usable price lines.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in LFA1, evaluates the defined error conditions: vendor pricing records must use the same pricing classification across the header and usable price lines.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Vendor pricing records MUST use the same pricing classification across the header and usable price lines.
-- Rule ID: ACE_00081
...
CREATE VIEW [dbo].[DQ_ACE00081_System_001_MAPL_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00081_System_001_MAPL_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00081_System_001_MAPL_OptSel]
WHERE
