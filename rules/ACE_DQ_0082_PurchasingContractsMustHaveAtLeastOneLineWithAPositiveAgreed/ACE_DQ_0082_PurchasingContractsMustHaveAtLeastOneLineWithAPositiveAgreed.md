# DQ Rule: ACE_00082 - Purchasing contracts MUST have at least one line with a positive agreed price or target amount.
...
|-------|-------|
| Rule ID | 00082 |
| Rule Name | Purchasing contracts MUST have at least one line with a positive agreed price or target amount. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0090_System_001_VBAK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: purchasing contracts must have at least one line with a positive agreed price or target amount.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in UNKNOWN, evaluates the defined error conditions: purchasing contracts must have at least one line with a positive agreed price or target amount.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Purchasing contracts MUST have at least one line with a positive agreed price or target amount.
-- Rule ID: ACE_00082
...
CREATE VIEW [dbo].[DQ_ACE00082_System_001_VBAK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00082_System_001_VBAK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00082_System_001_VBAK_OptSel]
WHERE
