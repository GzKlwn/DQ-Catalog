# DQ Rule: ACE_00018 - Equipment MUST NOT have overlapping validity periods for the same asset.
...
|-------|-------|
| Rule ID | 00018 |
| Rule Name | Equipment MUST NOT have overlapping validity periods for the same asset. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0026_System_001_MAPL_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: equipment must not have overlapping validity periods for the same asset.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in EQUI, evaluates the defined error conditions: equipment must not have overlapping validity periods for the same asset.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Equipment MUST NOT have overlapping validity periods for the same asset.
-- Rule ID: ACE_00018
...
CREATE VIEW [dbo].[DQ_ACE00018_System_001_MAPL_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00018_System_001_MAPL_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00018_System_001_MAPL_OptSel]
WHERE
