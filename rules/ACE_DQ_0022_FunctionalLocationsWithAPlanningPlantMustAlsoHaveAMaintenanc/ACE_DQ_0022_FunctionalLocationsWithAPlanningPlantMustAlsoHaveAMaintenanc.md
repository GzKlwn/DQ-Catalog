# DQ Rule: ACE_00022 - Functional locations with a planning plant MUST also have a maintenance plant.
...
|-------|-------|
| Rule ID | 00022 |
| Rule Name | Functional locations with a planning plant MUST also have a maintenance plant. |
| Rule Name Score | 100% |
...
| Generated View | DQ_0030_System_001_AUFK_OptSel |

## Description

**1. Functional/Business Description**

This rule validates data integrity by ensuring: functional locations with a planning plant must also have a maintenance plant.. Violations indicate records requiring investigation and remediation to maintain system consistency and data quality standards.
...
- **Check** <br /> For each record in AUFM, evaluates the defined error conditions: functional locations with a planning plant must also have a maintenance plant.. Flags records that violate the rule requirements.
...
```sql
-- ============================================================
-- DQ Rule: Functional locations with a planning plant MUST also have a maintenance plant.
-- Rule ID: ACE_00022
...
CREATE VIEW [dbo].[DQ_ACE00022_System_001_AUFK_OptSel] AS
...
CREATE VIEW [dbo].[DQ_ACE00022_System_001_AUFK_RptSel] AS

SELECT
    *

FROM [dbo].[DQ_ACE00022_System_001_AUFK_OptSel]
WHERE
